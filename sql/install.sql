...
-- Activiteitenweger database schema version: 4
...
--
-- Tabelstructuur voor tabel `recovery_credentials`
--
...
--
-- Indexen voor tabel `recovery_credentials`
--
ALTER TABLE `recovery_credentials`
  ADD PRIMARY KEY (`recovery_id`),
  ADD UNIQUE KEY `uq_recovery_secret_hash` (`secret_hash`),
  ADD KEY `idx_recovery_vault_status` (`vault_id`,`status`),
  ADD KEY `fk_recovery_epoch` (`vault_id`,`key_epoch`),
  ADD KEY `fk_recovery_created_by` (`created_by_device_id`),
  ADD KEY `fk_recovery_used_by` (`used_by_device_id`),
  ADD KEY `fk_recovery_revoked_by` (`revoked_by_device_id`);
...
--
-- Beperkingen voor tabel `recovery_credentials`
--
ALTER TABLE `recovery_credentials`
  ADD CONSTRAINT `fk_recovery_vault` FOREIGN KEY (`vault_id`) REFERENCES `vaults` (`vault_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_recovery_epoch` FOREIGN KEY (`vault_id`,`key_epoch`) REFERENCES `key_epochs` (`vault_id`, `epoch`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_recovery_created_by` FOREIGN KEY (`created_by_device_id`) REFERENCES `devices` (`device_id`) ON DELETE SET NULL,
  ADD CONSTRAINT `fk_recovery_used_by` FOREIGN KEY (`used_by_device_id`) REFERENCES `devices` (`device_id`) ON DELETE SET NULL,
  ADD CONSTRAINT `fk_recovery_revoked_by` FOREIGN KEY (`revoked_by_device_id`) REFERENCES `devices` (`device_id`) ON DELETE SET NULL;
